            ...
            <div class="mb-6">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <textarea id="job_description" name="description" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border" placeholder="Write your job description here..." required></textarea>
                    </div>
                </div>
